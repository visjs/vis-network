...
import { selectiveDeepExtend, Hammer, deepExtend, topMost, overrideOpacity, forEach, bridgeObject, mergeOptions, isString, selectiveNotDeepExtend, parseColor, fillIfDefined, VALIDATOR_PRINT_STYLE, getAbsoluteTop, getAbsoluteLeft, Popup, Alea, recursiveDOMDelete, HSVToHex, easingFunctions, Validator, Configurator, Activator } from 'vis-util/esnext/umd/vis-util.js';
import { v4 } from 'uuid';
...
function parseAttributeList() {
   ...
   */
  let attr_list = [];
  const attr_names = []; // used for checking the case.
 ...
 */
let Image$2 = class Image extends EndPoint {
    /**
 ...
 * @augments CircleImageBase
 */
let Image$1 = class Image extends CircleImageBase {
  /**
   * @param {object} options
   * @param {object} body
   * @param {Label} labelModule
