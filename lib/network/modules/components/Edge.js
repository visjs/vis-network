...
*/
        ...
        if (
          ...
          x = node1.x;
          y = node1.y;
          angle = this.options.selfReference.angle;
     
          var coordinates = ComponentUtil.getSelfRefCoordinates(ctx, this.options.selfReference.angle, node1);
          x = coordinates.x;
          y = coordinates.y;
        ...
        point = this._pointOnCircle(x, y, radius, angle);
        this.labelModule.draw(ctx, point.x, point.y, this.selected, this.hover);
      }
    }
  }
