...
*/
        ...
        var x, y;
        var radius = (typeof this.options.selfReferenceSize === "number")? this.options.selfReferenceSize : this.options.selfReferenceSize.size;
        ...
        if(this.options.selfReferenceSize.side !== null && typeof this.options.selfReferenceSize !== "number"){
          if(this.options.selfReferenceSize.side === "top"){
            ...
            x = node1.x;
            y = node1.y + node1.shape.height * 0.5;
            point = this._pointOnCircle(x, y, radius, -0.375);
            ...
            x = node1.x + node1.shape.width * 0.5;
            y = node1.y;             
            point = this._pointOnCircle(x, y, radius, 0.9);
          }else{
            //top center
            x = node1.x;
            y = node1.y - node1.shape.height * 0.5;
