...
class ShapeBase extends NodeBase {
  ...
  updateBoundingBox(x, y) {
    ...
    this.boundingBox.top = y - this.height;
    this.boundingBox.left = x - this.width;
    this.boundingBox.right = x + this.width;
    this.boundingBox.bottom = y + this.height;

    if (this.options.label !== undefined && this.labelModule.size.width > 0) {
      this.boundingBox.top = Math.min(this.boundingBox.top, this.labelModule.size.top);
