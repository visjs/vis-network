...
import CircleImageBase from "../util/CircleImageBase.js";
...
class Circle extends CircleImageBase {
  ...
  draw(ctx, x, y, selected, hover, values) {
    ...
    this._drawRawCircle(ctx, x, y, { ...values, size: this.radius });
  ...
  updateBoundingBox(x, y) {
    this.boundingBox.top = y - this.radius;
    this.boundingBox.left = x - this.radius;
    this.boundingBox.right = x + this.radius;
    this.boundingBox.bottom = y + this.radius;
  }
