...
import { setColorOptionsWithOpacity } from './shared/Color';
...
class Node {
  ...
  constructor(options, body, imagelist, grouplist, globalOptions, defaultOptions) {
    this.options = {...defaultOptions, ...globalOptions, ...options};
  ...
  static updateGroupOptions(parentOptions, newOptions, groupList) {
    ...
    groupObj.opacity = newOptions.opacity || parentOptions.opacity || 1;
  ...
  static parseOptions(parentOptions, newOptions, allowDeletion = false, globalOptions = {}, groupList) {
    ...
    parentOptions.opacity = newOptions.opacity || parentOptions.opacity || 1;
  ...
  getFormattingValues() {
    ...
    return setColorOptionsWithOpacity(values);
  }
