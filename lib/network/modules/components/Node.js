...
class Node {
  ...
  distanceToBorder(ctx, angle) {
    return this.shape.distanceToBorder(ctx,angle) + this._getEndpointsAdjustedPosition();
  }
  ...
  */
  ...
  /**
  * Find out the endpointsAdjustedPosition value
  * @private
  */
  _getEndpointsAdjustedPosition() {
    if (this.edges.length > 0) {
      return this.edges[0].globalOptions.arrowStrikethrough === true ? this.edges[0].globalOptions.endpointsAdjustedPosition : 0;
    } else {
      return 0;
    }
  }
