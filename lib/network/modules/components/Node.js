...
class Node {
  ...
  static updateGroupOptions(parentOptions, newOptions, groupList) {
    ...
    if (groupObj.opacity !== undefined && newOptions.opacity === undefined) {
      if (Number.isNaN(groupObj.opacity) || !Number.isFinite(groupObj.opacity) || groupObj.opacity < 0 || groupObj.opacity > 1) {
  ...
  static parseOptions(parentOptions, newOptions, allowDeletion = false, globalOptions = {}, groupList) {
    ...
    if (parentOptions.opacity !== undefined) {
      if (Number.isNaN(parentOptions.opacity) || !Number.isFinite(parentOptions.opacity) || parentOptions.opacity < 0 || parentOptions.opacity > 1) {
    ...
    if (newOptions.opacity !== undefined) {
      if (Number.isNaN(newOptions.opacity) || !Number.isFinite(newOptions.opacity) || newOptions.opacity < 0 || newOptions.opacity > 1) {
