...
import { addWheelListener } from './MouseWheelListener';
...
class Canvas {
  ...
  _bindHammer() {
    ...
    addWheelListener(this.frame.canvas, this.body.eventListeners.onMouseWheel, true);
    // this.frame.canvas.addEventListener(support, (event) => {this.body.eventListeners.onMouseWheel(event)});
