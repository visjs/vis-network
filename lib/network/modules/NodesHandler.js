  ...
  setOptions(options) {
    if (options !== undefined) {
      ...
      if (options.opacity !== undefined) {
        if (isNaN(options.opacity) || !isFinite(options.opacity) || options.opacity < 0 || options.opacity > 1) {
          console.error("Invalid option for node opacity. Value must be between 0 and 1");
        }
        else {
