...
const allOptions = {
  ...
  edges: {
    ...
    smooth: {
      enabled: { boolean: bool },
      type: { string: ['dynamic', 'continuous', 'discrete', 'diagonalCross', 'straightCross', 'horizontal', 'vertical', 'curvedCW', 'curvedCCW', 'cubicBezier', 'arc'] },
      roundness: { number },
...
const configureOptions = {
  ...
  edges: {
    ...
    smooth: {
      enabled: true,
      type: ['dynamic', 'continuous', 'discrete', 'diagonalCross', 'straightCross', 'horizontal', 'vertical', 'curvedCW', 'curvedCCW', 'cubicBezier', 'arc'],
      forceDirection: ['horizontal', 'vertical', 'none'],
      roundness: [0.5, 0, 1, 0.05],
      radius: [0,100,200,400],
    },
    width: [1, 0, 30, 1]
  },
  layout: {
