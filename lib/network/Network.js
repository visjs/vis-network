...
export function Network(container, data, options) {
   ...
   *
   * 'edges' and 'nodes' contain the full definitions of all the network
   * elements. 'nodeIndices' and 'edgeIndices' contain the id's of the active
   * elements.
   *
   * The distinction is important, because a defined node need not be active,
   * i.e. visible on the canvas. This happens in particular when clusters are
   * defined, in that case there will be nodes and edges not displayed. The
   * bottom line is that all code with actions related to visibility, *must* use
   * 'nodeIndices' and 'edgeIndices', not 'nodes' and 'edges' directly.
   *
   * Declaring the property like this prevents Vue reactivity from messing with
   * the state when someone places Vis Network instance among reactive data.
   * It's generally considered bad practice to do so and it doesn't have much of
   * a benefit (actually it comes with quite hefty performance hit), but people
   * do it anyway. This will protect our state so that they can do it without
   * encountering weird and confusing bugs.
   */
  ...
  Object.defineProperty(this, "images", {
    value: new Images(() => this.body.emitter.emit("_requestRedraw")), // object with images
  });
  Object.defineProperty(this, "groups", {
    value: new Groups(), // object with groups
  });
  Object.defineProperty(this, "canvas", {
    value: new Canvas(this.body), // DOM handler
  });
  Object.defineProperty(this, "selectionHandler", {
    value: new SelectionHandler(this.body, this.canvas), // Selection handler
  });
  Object.defineProperty(this, "interactionHandler", {
    value: new InteractionHandler(this.body, this.canvas, this.selectionHandler), // Interaction handler handles all the hammer bindings (that are bound by canvas), key
  });
  Object.defineProperty(this, "view", {
    value: new View(this.body, this.canvas), // camera handler, does animations and zooms
  });
  Object.defineProperty(this, "renderer", {
    value: new CanvasRenderer(this.body, this.canvas), // renderer, starts renderloop, has events that modules can hook into
  });
  Object.defineProperty(this, "physics", {
    value: new PhysicsEngine(this.body), // physics engine, does all the simulations
  });
  Object.defineProperty(this, "layoutEngine", {
    value: new LayoutEngine(this.body), // layout engine for inital layout and hierarchical layout
  });
  Object.defineProperty(this, "clustering", {
    value: new ClusterEngine(this.body), // clustering api
  });
  Object.defineProperty(this, "manipulation", {
    value: new ManipulationSystem(
      this.body,
      this.canvas,
  ...
  Object.defineProperty(this, "nodesHandler", {
    value: new NodesHandler(
      this.body,
      this.images,
      this.groups,
      this.layoutEngine
  ...
  Object.defineProperty(this, "edgesHandler", {
    value: new EdgesHandler(this.body, this.images, this.groups), // Handle adding, deleting and updating of edges as well as global options
  });
