...
Network.prototype.setData = function (data) {
  ...
  if(data && data.options && data.options.edges && data.options.edges.hasOwnProperty("selfReferenceSize")){
    console.log('The selfReferenceSize property has been deprecated. Please use selfReference property instead. The selfReference can be set like thise selfReference:{size:30, angle:null}');
    if(!data.options.edges.hasOwnProperty("selfReference")){
      data.options.edges.selfReference = {
          size: data.options.edges.selfReferenceSize,
          angle: null
      }
    }
  }
