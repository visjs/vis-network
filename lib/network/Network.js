...
export function Network(container, data, options) {
  ...
  this.body = {
	...
	if(options.zIndexField){
		...
		this.body.zIndexCompare = options.zIndexCompare || ((a,b)=>parseInt(a)-parseInt(b)); // defaults to integer comparison if nothing else given
	}
...
Network.prototype.bindEventListeners = function () {
  ...
  this.body.emitter.on("_dataUpdated", () => {
    ...
    this._updateVisibleIndices();
		if(this.body.zIndexField && this.body.zIndexCompare){
