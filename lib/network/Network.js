...
Network.prototype.setData = function (data) {
  ...
  if(data && data.options && data.options.edges && data.options.edges.hasOwnProperty("selfReferenceSize")){
    console.log('The selfReferenceSize property has been deprecated. Please use selfReference property instead. The selfReference can be set like thise selfReference:{size:30, side:"top"}');
