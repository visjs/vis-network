...
describe('ColorPicker', function() {
  ...
  describe('constructor', function() {
    it('sets defaults', function() {
      ...
      assert.deepEqual(colorPicker.centerCoordinates, {
        x: 289 / 2,
        y: 289 / 2
      })
      ...
      assert.deepEqual(colorPicker.initialColor, {
        r: 255,
        g: 255,
        b: 255,
        a: 1.0
  ...
  describe('setUpdateCallback', function() {
    it('prevents non-functions from being set as callback', function() {
      ...
      assert.throws(
        function() {
          colorPicker.setUpdateCallback(null)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setUpdateCallback(undefined)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setUpdateCallback([1, 2, 3])
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setUpdateCallback({ a: 42 })
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setUpdateCallback(42)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setUpdateCallback('meow')
        },
        Error,
        null
      )
  ...
  describe('setCloseCallback', function() {
    it('prevents non-functions from being set as callback', function() {
      ...
      assert.throws(
        function() {
          colorPicker.setCloseCallback(null)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setCloseCallback(undefined)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setCloseCallback([1, 2, 3])
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setCloseCallback({ a: 42 })
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setCloseCallback(42)
        },
        Error,
        null
      )
      assert.throws(
        function() {
          colorPicker.setCloseCallback('meow')
        },
        Error,
        null
      )
